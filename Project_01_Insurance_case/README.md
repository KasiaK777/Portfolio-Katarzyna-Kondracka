...
Celem projektu jest przeprowadzenie kompleksowej analizy danych dotyczących szkód ubezpieczeniowych z pierwszego kwartału 2023 roku.
Projekt obejmuje:
...
EDA – wstępna analiza danych
Feature engineering – tworzenie zmiennych pochodnych
Analiza braków danych i ich imputacja
Wizualizacje danych (Seaborn, Matplotlib)
Macierz korelacji
Segmentacja klientów (K-Means)
Normalizacja danych (StandardScaler)
